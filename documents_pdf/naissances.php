...
if ($role === 'administrateur') {
    $sql = "SELECT d.*, n.numero_acte, a.nom AS nom_arrondissement
            FROM documents_generes d
            INNER JOIN naissances n ON d.reference_id = n.id
            LEFT JOIN arrondissements a ON n.arrondissement_id = a.id
            WHERE d.type_document = 'naissance'
...
<div class="main-content">
    <h1>PDF des actes de naissance</h1>
